...
function Tending() {
    ...
    useEffect(() => {
        fetch('https://academics.newtonschool.co/api/v1/music/song?filter={"featured":"Trending songs"}&limit=50', {
            headers: {
    ...
    return (
        <>
            <h2 className="text-xl font-semibold mb-2">Tending Songs</h2>
